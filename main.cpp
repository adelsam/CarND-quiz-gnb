...
int main() {
  ...
  string root = "/Users/adelman/Code/sdc/term3/quiz-gnb/nd013_pred_data/";
  vector< vector<double> > X_train = Load_State(root + "train_states.txt");
  vector< vector<double> > X_test  = Load_State(root + "test_states.txt");
  vector< string > Y_train  = Load_Label(root + "train_labels.txt");
  vector< string > Y_test   = Load_Label(root + "test_labels.txt");
